...
function Input(props: Readonly<Props>) {
    ...
    let base = "border border-(--g7) flex-auto transition-colors rounded-md"+
        " ease-in-out duration-200 text-sm py-2 px-2.5 focus:outline-0"+
        " focus-visible:outline-0 focus-within:outline-0 focus:ring-0 focus-visible:ring-0"+
        " focus-within:ring-0 placeholder:text-(--g8) focus:bg-(--g3) focus-within:bg-(--g3)"+
        " focus-visible:bg-(--g3)"
